...
function validate(input){
    ...
    if (!input.name || !/^[A-Za-z0-9\s]+$/g.test(input.name)){
        errors.name = 'Nombre Unicamente con Letras y Numeros';
    }
            ...
            <form className={s.form} onSubmit={(e)=>handleSubmit(e)}>
                ...
                <ul className={s.ul}><li className={s.lista}>{input.temperament.map(el=> <button className={s.botonTemp} type='button' key={el.id} onClick={()=>handleDelete(el)}>{el}</button>)}</li></ul>
                 <div>
                    ...
                    <br/>
                    <input autocomplete="off" type="text" value={input.height_min} name='height_min' id='height_min'  placeholder="Ingresa Tamaño Min" onChange={(e)=>handleChange(e)}/>
                    Cms
                    {errors.height_min && (<p className= {s.danger} >{errors.height_min}</p>)}
                    <label htmlFor="height_max"></label>
                    <input autocomplete="off"  type="text" value={input.height_max} name='height_max' id='height_max'  placeholder="Ingresa Tamaño Max" onChange={(e)=>handleChange(e)}/>
                     Cms
                ...
                <div>
                    ...
                    <br/>
                     <input autocomplete="off"  type="text" value={input.weight_min} name='weight_min' id='weight_min' placeholder="Ingresa Peso Min"  onChange={(e)=>handleChange(e)} />
                      Kgs
                      {errors.weight_min && (<p className= {s.danger} >{errors.weight_min}</p>)}

                     <label htmlFor="weight_max"></label>
                     <input autocomplete="off"  type="text" value={input.weight_max} name='weight_max' id='weight_max' placeholder="Ingresa Peso Max"  onChange={(e)=>handleChange(e)} />
                      Kgs
                ...
                <div>
                    ...
                    <br/>
                    <input autocomplete="off"  type="text" value={input.life_time_min} name='life_time_min' id='life_time_min' placeholder="Ingresa Tiempo de Vida Min"  onChange={(e)=>handleChange(e)} />
                     Años
                     {errors.life_time_min && (<p className= {s.danger} >{errors.life_time_min}</p>)}

                    <label htmlFor="life_time_max"></label>
                    <input autocomplete="off" type="text" value={input.life_time_max} name='life_time_max' id='life_time_max' placeholder="Ingresa Tiempo de Vida Max"  onChange={(e)=>handleChange(e)} />
                     Años
